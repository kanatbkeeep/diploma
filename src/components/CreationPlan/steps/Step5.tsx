...
const Step5 = (props: any) => {
    ...
    const validation = () => {
        return (planStore.step5.nameOfTheWork && planStore.step5.deadlines&& planStore.step5.results
            && planStore.step5.comments  && ((planStore.step5.infoImplementation !== "Other/Другое/Басқа" && planStore.step5.infoImplementation) ? planStore.step5.infoImplementation : planStore.step5.anotherInfoImpl ) );
    }
    ...
    const edit = (item: any) => {
        const toUpdate = {
            id: item.id,
            nameOfTheWork: planStore.step5.nameOfTheWork,
            deadlines: planStore.step5.deadlines,
            infoImplementation: planStore.step5.infoImplementation !== "Other/Другое/Басқа" ? planStore.step5.infoImplementation : planStore.step5.anotherInfoImpl,
            results: planStore.step5.results,
            comments: planStore.step5.comments,
        }
            ...
            <div className="inputs-step">
                ...
                <div style={{marginBottom: 20, display: "flex"}}>
                    ...
                    <Dropdown maxWidth={300}
                              ...
                              value={planStore.step5.infoImplementation ? implShow(planStore.step5.infoImplementation) : t('select')}
                    >
                        <ul>
                ...
                {
                    planStore.step5.infoImplementation === "Other/Другое/Басқа" ?
                        <div style={{marginTop: 20, marginBottom: 20, display: "flex"}}>
                            <Input
                                maxWidth={500}
                                label={t('infoOnImplementation')}
                                value={planStore.step5.anotherInfoImpl}
                                onChange={(e: any) => {
                                    planStore.editStep5Modal({anotherInfoImpl: e.target.value});
                                }
                                }
                            />
                        </div> : null
